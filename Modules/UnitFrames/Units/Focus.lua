...
-- Focus unit style (matches TargetOfTarget styling)
local function FocusStyle(self, unit)
    -- Set focus-specific frame size (same as ToT)
    self:SetSize(110, 12)

    -- Health percentage and name text (left-aligned with diamond glyph)
    ...
    -- Register tags (asterisk glyph instead of right angled quote)
...
UnitFrames.FocusStyle = FocusStyle
